...
This project uses a monorepo with a NestJS API, Next.js frontend, a shared TypeScript package, and PostgreSQL as the primary SQL database.
...
See `docs/sql-database-details.md` for the full PK/FK schema.
